...
int main(int argc, char *argv[])
{
    ...
    105a:	e8 21 00 00 00       	call   1080 <recursion>
    printf(1, "Yielded value: %d\n", m);
    105f:	c7 44 24 04 f9 17 00 	movl   $0x17f9,0x4(%esp)
    1066:	00 
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    13c9:	0f b6 92 13 18 00 00 	movzbl 0x1813(%edx),%edx
  }while((x /= base) != 0);
    ...
    143e:	8d 45 10             	lea    0x10(%ebp),%eax
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    155f:	8b 38                	mov    (%eax),%edi
          s = "(null)";
    1561:	b8 0c 18 00 00       	mov    $0x180c,%eax
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    1621:	a1 e8 1a 00 00       	mov    0x1ae8,%eax
{
  ...
  freep = p;
    1669:	a3 e8 1a 00 00       	mov    %eax,0x1ae8
}
    166e:	5b                   	pop    %ebx
    166f:	5e                   	pop    %esi
    1670:	5f                   	pop    %edi
  ...
  freep = p;
    1692:	a3 e8 1a 00 00       	mov    %eax,0x1ae8
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    16bc:	8b 1d e8 1a 00 00    	mov    0x1ae8,%ebx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p == freep)
    16fb:	3b 15 e8 1a 00 00    	cmp    0x1ae8,%edx
  ...
  return freep;
    1732:	8b 15 e8 1a 00 00    	mov    0x1ae8,%edx
    ...
    1754:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
    1757:	89 15 e8 1a 00 00    	mov    %edx,0x1ae8
      return (void*)(p + 1);
    ...
    base.s.ptr = freep = prevp = &base;
    176e:	c7 05 e8 1a 00 00 ec 	movl   $0x1aec,0x1ae8
    1775:	1a 00 00 
    base.s.size = 0;
    1778:	ba ec 1a 00 00       	mov    $0x1aec,%edx
    base.s.ptr = freep = prevp = &base;
    177d:	c7 05 ec 1a 00 00 ec 	movl   $0x1aec,0x1aec
    1784:	1a 00 00 
    base.s.size = 0;
    1787:	c7 05 f0 1a 00 00 00 	movl   $0x0,0x1af0
    178e:	00 00 00 
